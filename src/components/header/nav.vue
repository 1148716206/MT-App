    ...
    <ul class="nav">
      ...
      <li class="list site">
        ...
        <div class="subContainer">
          ...
          <dl class="app">
            <dt>手机应用</dt>
            <dd><img src="//s0.meituan.net/bs/fe-web-meituan/2d53095/img/appicons/meituan.png"
                     alt="美团app"></dd>
            <dd><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/waimai.png"
                     alt="外卖app"></dd>
            <dd><img src="https://p0.meituan.net/travelcube/162c3308d9622f6d9cfaa49e60be4dca8573.png"
                     alt="民宿app"></dd>
            <dd><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/dianping.png"
                     alt="点评app"></dd>
            <dd><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/maoyan.png"
                     alt="猫眼app"></dd>
